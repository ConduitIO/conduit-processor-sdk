...
func TestCachedSchemaService_Get(t *testing.T) {
	...
	req1 := pprocutils.GetSchemaRequest{
		Subject: "test",
		Version: 1,
	}
	resp1 := pprocutils.GetSchemaResponse{
	...
	req2 := pprocutils.GetSchemaRequest{
		Subject: "test",
		Version: 2,
	}
	resp2 := pprocutils.GetSchemaResponse{
		Schema: schema.Schema{
			ID:      2,
			Subject: "test",
			Version: 2,
...
func TestCachedSchemaService_Create(t *testing.T) {
	...
	req1 := pprocutils.CreateSchemaRequest{
		Subject: "test",
		Type:    schema.TypeAvro,
		Bytes:   []byte("int"),
	}
	resp1 := pprocutils.CreateSchemaResponse{
		Schema: schema.Schema{
			ID:      1,
			Subject: "test",
			Version: 1,
	...
	req2 := pprocutils.CreateSchemaRequest{
		Subject: "test",
		Type:    schema.TypeAvro,
		Bytes:   []byte("string"),
	}
	resp2 := pprocutils.CreateSchemaResponse{
		Schema: schema.Schema{
			ID:      2,
			Subject: "test",
			Version: 2,
